  ...
  //  alert('It Seems you Scan Other Than Larder Code')
    ...
    if (this.state.check == false){
      this.setState({check :true})
        ...
        const url = 'http://139.59.76.223/larder/webservice/scan_door_replenisher'
...
alert('Please Wait. We are processing your previous order')
           ...
           alert('In the land of blackouts, we are suffering from a "Net Out". Please try after 2 minutes')
       }

       else if (code == previous) {
           alert('We are processing the previous order of your fellow mates. Please try again after 2 minutes.')
       }
